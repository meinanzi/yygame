...
}  NET_ROOM_CONTEST_PEOPLE_RESULT;
...
}  NET_ROOM_CONTEST_CHANGE_RESULT;
...
typedef struct NET_ROOM_CONTEST_RECORD_RESULT
{
	...
	BYTE	bBestRank;		  // 最佳排名
}  NET_ROOM_CONTEST_RECORD_RESULT;
