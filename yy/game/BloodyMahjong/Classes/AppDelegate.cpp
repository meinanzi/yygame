...
// 更新授权码
static std::string APP_INFO_KEY("20100304");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(XZMJ::NAME_ID, HNGameCreator::NORMAL, GAME_CREATE_SELECTOR(XZMJ::GameTableUI::create));
