#ifndef __GoldenToad_GameAdmin_H__
#define __GoldenToad_GameAdmin_H__
...
{
	class GameAdmin : public HNLayer
	{
	public:
	...
	public:
		...
		//创建受控玩家列表
		void createControlList(std::vector<ControlInfo> controls);
		//创建特殊鱼受控玩家列表
		void createSprcialList(std::vector<SpecialUser>	specias);
