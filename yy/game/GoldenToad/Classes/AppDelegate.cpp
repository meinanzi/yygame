...
// 更新授权码
static std::string APP_INFO_KEY("33003106");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(GoldenToad::GAME_NAME_ID, HNGameCreator::NORMAL, GAME_CREATE_SELECTOR(GoldenToad::GameTableUI::create));
