...
// 更新授权码
static std::string APP_INFO_KEY("20111004");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(ZYHZ::NAME_ID, HNGameCreator::NORMAL, GAME_CREATE_SELECTOR(ZYHZ::GameTableUI::create));
