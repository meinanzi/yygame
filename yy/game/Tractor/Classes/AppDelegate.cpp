...
// 更新授权码
static std::string APP_INFO_KEY("12111006");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(TRACTOR::GAME_NAME_ID, HNGameCreator::NORMAL, GAME_CREATE_SELECTOR(TRACTOR::GameTableUI::create));
