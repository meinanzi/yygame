...
// 更新授权码
static std::string APP_INFO_KEY("11100200");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(BJL::BJL_COMMAND::GAME_NAME_ID, HNGameCreator::BR, GAME_CREATE_SELECTOR(BJL::GameTableUI::create));
