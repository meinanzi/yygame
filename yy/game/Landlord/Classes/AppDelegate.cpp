...
// 更新授权码
static std::string APP_INFO_KEY("10100003");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(landlord::GAME_NAME_ID, HNGameCreator::NORMAL, GAME_CREATE_SELECTOR(landlord::GameTableUI::create));
