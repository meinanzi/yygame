...
// 更新授权码
static std::string APP_INFO_KEY("31010100");
...
void AppDelegate::initGameConfig()
{
	...
	HNGameCreator::getInstance()->addGame(DriftingCar::Game_ID::NAME_ID, HNGameCreator::BR, GAME_CREATE_SELECTOR(DriftingCar::GameTableUI::create));
