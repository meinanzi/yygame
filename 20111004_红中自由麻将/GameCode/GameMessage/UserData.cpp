...
{
	OutputDebugString("20160615::UserData::IsHaveAHandPai-0");
	if(station <0 || station>=PLAY_COUNT)
		return false;
	OutputDebugString("20160615::UserData::IsHaveAHandPai-1");
	for(int i=0;i<HAND_CARD_NUM;i++)
	{
		if(m_byArHandPai[station][i] == pai)
		{
			OutputDebugString("20160615::UserData::IsHaveAHandPai-2");
			return true;
		}
	}
	OutputDebugString("20160615::UserData::IsHaveAHandPai-3");
	return false;
}
